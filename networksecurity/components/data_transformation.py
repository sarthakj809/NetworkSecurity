...
from networksecurity.entity.artifact_entity import DataValidationAritfact,DataTransformationArtifact
...
class DataTransformation:
    def __init__(self,data_validation_artifact:DataValidationAritfact,data_transformation_config:DataTransformationConfig):
        try:
            self.data_validation_artifact:DataValidationAritfact=data_validation_artifact
